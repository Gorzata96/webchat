...
window.onload = function () {
    ...
    document.getElementById("sendusername").addEventListener("click", function () {
        ...
        sendMessage("_username: \""+document.getElementById("username").value+"\"");
    ...
    document.getElementById("username").addEventListener("keypress", function (e) {
        if(e.keyCode === 13) {
            ...
            sendMessage("_username: \""+e.target.value+"\"");
            document.getElementById("userdialog").style.display = "none";
        }
    });

    document.getElementById("sendnewchannel").addEventListener("click", function (e) {
        sendMessage("_newchannel: \""+document.getElementById("newchannel").value+"\"");
    ...
    document.getElementById("newchannel").addEventListener("keypress", function (e) {
        if (e.keyCode === 13) {
            ...
            sendMessage("_newchannel: \""+e.target.value+"\"");
            document.getElementById("newchannel").value = "";
            document.getElementById("message").disabled = false;
            document.getElementById("send").disabled = false;
        }
...
function changeChannel(newchannel) {
    sendMessage("_newchannel: \""+newchannel+"\"");
    document.getElementById("message").disabled = false;
    document.getElementById("send").disabled = false;
}
...
function updateChat(msg) {
    ...
    document.getElementById("channelname").innerHTML = "<p> Channel: " + data.channelname + "</p>";
